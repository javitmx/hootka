...
CREATE DATABASE IF NOT EXISTS kahoot_db CHARACTER SET utf8mb4 COLLATE utf8mbmb4_unicode_ci;
USE kahoot_db;
...
1. ##Abre tu Terminal/Consola: En la carpeta de tu proyecto game-live (donde está app.py), haz clic derecho en un espacio vacío y selecciona "Open Git Bash Here" (o usa el Símbolo del sistema de Windows).

2. ##Activa el Entorno Virtual: Es una "burbuja" de Python para este proyecto. Así no hay conflictos con otros programas.
...
3.##Instala los "ingredientes" (dependencias): Este comando lee el archivo requirements.txt y descarga todo lo que necesita la aplicación.
...
si todo va bien, veras un mensaje como este:
Running on [http://127.0.0.1:5000](http://127.0.0.1:5000)
 Press CTRL+C to quit

###🌐 ¡A Jugar! (Verificar el funcionamiento)
1.Abre tu navegador web y ve a la dirección que te dio la terminal: #👉 http://127.0.0.1:5000#
...
##Desarrollado por:## JaviTMX ##Version:##1.0.0 ##Licencia:##Free-Code 
